      ...
      <div className='flex banner relative flex-col w-full max-md:hidden'>
        ...
        >
          ...
          <div className="z-[2] flex justify-center gap-7 w-fit mx-auto lg:w-4/5 max-lg:mx-4">
            ...
            <BannerItem icon={Sell}>Sell design assets and make money creating what you love</BannerItem>
            <BannerItem icon={Job}>Find your next full time or freelance opportunity</BannerItem>
